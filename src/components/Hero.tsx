    ...
    <div className="container mx-auto text-left w-full px-4">
        <div className="max-w-2xl lg:max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white mb-6">
                <span className="block">3 años combatiendo</span>
                <span className="text-yellow-400">la corrosión</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-yellow-500 hover:bg-yellow-600 text-blue-900 font-bold py-3 px-6 rounded-lg transition-all duration-300">
            ...
            <div className="mt-10 flex items-center">
                ...
                <span className="text-white/80 font-medium">+500 proyectos protegidos en 2024</span>
            </div>
        </div>
    </div>
</section>
